...
from swagger_spec_validator3.util import validate_spec_url
...
@mock.patch('swagger_spec_validator3.util.read_url')
@mock.patch('swagger_spec_validator3.util.get_validator')
